...
"guibg=#c0e8ff
hi Visual       gui=NONE guifg=NONE guibg=#FFFDF5
" hi VisualNOS    gui=NONE guifg=#484848 guibg=#e0e0e0

" Syntax group
hi Boolean      guifg=#ff9900
...
"#f030d0
hi String       guifg=#889944
hi Todo         gui=UNDERLINE guifg=#ff0070 guibg=#ffe0f4
hi Type         gui=NONE guifg=#9A66B3 guibg=NONE
